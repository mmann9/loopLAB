...
export function layer(assembler: (addLayerCallback: (layerToAdd: IconLookup | IconLookup[]) => void) => void): Layer;
...
declare const api: {
    ...
    layer(assembler: (addLayerCallback: (layerToAdd: IconLookup | IconLookup[]) => void) => void): Layer;
